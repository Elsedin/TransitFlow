...
class TransportLineService {
  ...
  Future<List<models.TransportLine>> getAll({
    ...
    throw Exception(ApiError.fromResponseBody(response.body, fallback: 'Učitavanje linija nije uspjelo'));
  }
  ...
  Future<models.TransportLine?> getById(int id) async {
    ...
    throw Exception(ApiError.fromResponseBody(response.body, fallback: 'Učitavanje linije nije uspjelo'));
  }
  ...
  Future<models.Route?> getRouteByLineId(int transportLineId) async {
    ...
    throw Exception(ApiError.fromResponseBody(response.body, fallback: 'Učitavanje rute nije uspjelo'));
  }
  ...
  Future<List<models.Schedule>> getSchedulesByRouteId(int routeId) async {
    ...
    throw Exception(ApiError.fromResponseBody(response.body, fallback: 'Učitavanje voznog reda nije uspjelo'));
  }
  ...
  Future<List<models.NextDeparture>> getNextDepartures(int routeId, {int count = 3}) async {
    ...
    throw Exception(ApiError.fromResponseBody(response.body, fallback: 'Učitavanje sljedećih polazaka nije uspjelo'));
  }
}
